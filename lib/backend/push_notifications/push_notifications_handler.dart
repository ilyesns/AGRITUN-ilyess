...
final parametersBuilderMap =
  ...
  'taskDetails': (data) async => ParameterData(
        allParams: {
          'taskDetails': getParameter<DocumentReference>(data, 'taskDetails'),
        },
      ),
  ...
  'platformDetails': (data) async => ParameterData(
        allParams: {
          'platformDetails':
              getParameter<DocumentReference>(data, 'platformDetails'),
        },
      ),
  'tasks': ParameterData.none(),
  'WeatherPage': ParameterData.none(),
  'MessagePage': ParameterData.none(),
  'InviteUser': ParameterData.none(),
  'listdevice': ParameterData.none(),
  ...
  'PhonePage': ParameterData.none(),
  'VerifyCodePhone': ParameterData.none(),
};
