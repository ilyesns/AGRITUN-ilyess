...
class AppStateNotifier extends ChangeNotifier {
  YagriFirebaseUser? initialUser;
  YagriFirebaseUser? user;
  ...
  void update(YagriFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => TaskDetailsWidget(
                taskDetails: params.getParam('taskDetails',
                    ParamType.DocumentReference, false, ['users', 'tasks']),
              ),
            ),
            FFRoute(
              name: 'editProfile',
            ...
            FFRoute(
              ...
              builder: (context, params) => PlatformDetailsWidget(
                platformDetails: params.getParam('platformDetails',
