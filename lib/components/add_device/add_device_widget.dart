...
class _AddDeviceWidgetState extends State<AddDeviceWidget>
  ...
  void initState() {
    ...
    _model.nameDeviceController ??= TextEditingController();
    _model.snDeviceController ??= TextEditingController();
    setupAnimations(
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 16.0, 0.0, 0.0),
                                child: TextFormField(
                                  controller: _model.nameDeviceController,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      '12d3i134' /* Name device */,
                                    ),
                                    labelStyle:
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 16.0, 0.0, 0.0),
                                child: TextFormField(
                                  controller: _model.snDeviceController,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      'b8e4pm8r' /* Enter serial number */,
                                    ),
                                    labelStyle:
                                        FlutterFlowTheme.of(context).bodyText2,
                                    enabledBorder: OutlineInputBorder(
                                  ...
                                  validator: _model.snDeviceControllerValidator
                                      .asValidator(context),
                                ).animateOnPageLoad(animationsMap[
                          ...
                          child: Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'ADD_DEVICE_COMP_CANCEL_BTN_ON_TAP');
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'ADD_DEVICE_COMP_ADD_DEVICE_BTN_ON_TAP');
                                  ...
                                  _model.verf = await actions.verifyYDDocs(
                                    ...
                                    if (_model.verf2!) {
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          ...
                                          backgroundColor: Color(0xFF66E202),
                                        ),
                                      );
                                    } else {
                                      logFirebaseEvent('Button_bottom_sheet');
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'This device linked to another user!',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyText1
                                                .override(
                                                  fontFamily: 'Outfit',
