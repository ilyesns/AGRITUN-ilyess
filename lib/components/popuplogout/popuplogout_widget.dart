...
import 'popuplogout_model.dart';
export 'popuplogout_model.dart';

class PopuplogoutWidget extends StatefulWidget {
  const PopuplogoutWidget({
    Key? key,
    this.idplat,
  }) : super(key: key);
                            ...
                            child: Row(
                              ...
                              children: [
                                FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'POPUPLOGOUT_COMP_CANCEL_BTN_ON_TAP');
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'POPUPLOGOUT_COMP_CONFIRM_BTN_ON_TAP');
