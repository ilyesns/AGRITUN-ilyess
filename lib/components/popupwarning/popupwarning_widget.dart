...
import 'popupwarning_model.dart';
export 'popupwarning_model.dart';
...
class PopupwarningWidget extends StatefulWidget {
  ...
  @override
  _PopupwarningWidgetState createState() => _PopupwarningWidgetState();
}
                            ...
                            child: Row(
                              ...
                              children: [
                                FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'POPUPWARNING_COMP_CANCEL_BTN_ON_TAP');
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'POPUPWARNING_COMP_CONFIRM_BTN_ON_TAP');
                                    logFirebaseEvent('Button_custom_action');
                                    await actions.deleteDocs(
                                      widget.idplat,
                                    );
                                    logFirebaseEvent('Button_backend_call');
                                    await widget.idplat!.delete();
                                    logFirebaseEvent('Button_show_snack_bar');
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'You have deleted your platform!',
